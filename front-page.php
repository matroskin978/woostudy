...
<div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3"><?php _e( 'Featured Products', 'woostudy' ) ?></span>
    </h2>
    <div class="row px-xl-5">
...
<!-- Products Start -->
<div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3"><?php _e( 'Recent Products', 'woostudy' ) ?></span>
    </h2>
    <div class="row px-xl-5">
