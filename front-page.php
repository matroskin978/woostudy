...
<div class="container-fluid mb-3">
    <div class="row px-xl-5">
        ...
        <div class="col-lg-8">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp"
                                       href="<?php the_permalink(); ?>"><?php _e( 'Shop Now', 'woostudy' ) ?></a>
                                </div>
                            </div>
                        </div>
                        <?php $i++; endforeach; ?>
            ...
            <?php else: ?>
                <p><?php _e( 'Slider here...', 'woostudy' ) ?></p>
        ...
        <div class="col-lg-4">
            <div class="product-offer mb-30" style="height: 200px;">
                <img class="img-fluid" src="<?php echo get_template_directory_uri() ?>/assets/img/offer-1.jpg"
                     alt="">
            ...
            <div class="product-offer mb-30" style="height: 200px;">
                <img class="img-fluid" src="<?php echo get_template_directory_uri() ?>/assets/img/offer-2.jpg"
                     alt="">
                <div class="offer-text">
                    <h6 class="text-white text-uppercase">Save 20%</h6>
                    <h3 class="text-white mb-3">Special Offer</h3>
...
<div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span
                class="bg-secondary pr-3"><?php _e( 'Recent Products', 'woostudy' ) ?></span>
    </h2>
    <div class="row px-xl-5">
